...
import com.company.M2ChallengeDiazNicholas.models.CustomErrorResponse;
import com.company.M2ChallengeDiazNicholas.exceptions.NotFoundException;
...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<CustomErrorResponse> handleWrongInputException(IllegalArgumentException e) {
